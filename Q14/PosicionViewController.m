//
//  PosicionViewController.m
//  Quiniela 14
//
//  Created by Miguel Caballero on 14/04/14.
//  Copyright (c) 2014 Comunicación Interactiva DeRu. All rights reserved.
//

#import "PosicionViewController.h"

@interface PosicionViewController ()

@end

@implementation PosicionViewController
...
- (void)viewDidLoad
{
    ...
    NSString *fullURL = @"http://quiniela14.mx/mundial/grupos.php";
