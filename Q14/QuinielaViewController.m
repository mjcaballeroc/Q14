...
#import "QuinielaViewController.h"

@interface QuinielaViewController ()

@end

@implementation QuinielaViewController
...
- (void)viewDidLoad
{
    ...
    NSString *fullURL = @"http://quiniela14.mx/mundial/quiniela.php";
...
-(void)webb:(UIWebView *)webb didFailLoadWithError:(NSError *)error {
